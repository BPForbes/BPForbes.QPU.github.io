...
\subsection{\code{-BASIS}: measurement observable (optional)}

Only \code{MEASURE} accepts \code{-BASIS}, followed by \code{X}, \code{Y}, or
\code{Z} in either case:
\begin{lstlisting}
MEASURE -I Q -BASIS X
\end{lstlisting}
Z is the default. A missing or unknown basis, or \code{-BASIS} on any other
