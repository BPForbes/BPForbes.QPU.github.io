...
\end{lstlisting}
The named token must already have been measured. If the classical bit does not
match, the gate is skipped and execution continues. There is no \code{IF}/\code{ENDIF}
block and no backward edge---the circuit remains a finite ordered list.
