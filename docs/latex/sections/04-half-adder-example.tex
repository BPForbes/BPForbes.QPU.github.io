...
\begin{tikzpicture}[scale=.82]
  ...
  \draw[double distance=1.4pt,thick] (0,-2.45)--(8,-2.45);
  \node[left] at (0,-2.45) {c};
  \node[left,font=\scriptsize] at (0.35,-2.15) {/4};
  ...
  \QpuMeter{6.2}{-.5}
  \QpuMeter{7.15}{-1.5}
  \draw[double distance=1.4pt,thick,-{Latex[length=1.6mm]}] (6.2,-.5)--(6.2,-2.45);
  \draw[double distance=1.4pt,thick,-{Latex[length=1.6mm]}] (7.15,-1.5)--(7.15,-2.45);
  \node[right,font=\scriptsize] at (6.2,-2.15) {2};
  \node[right,font=\scriptsize] at (7.15,-2.15) {3};
\end{tikzpicture}
\end{center}
