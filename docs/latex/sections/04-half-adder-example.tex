...
\begin{tikzpicture}[scale=.82]
  \foreach \y/\name in {1.5/A,.5/B,-.5/Sum,-1.5/Carry} {
    \draw[thick] (0,\y)--(5.85,\y);
    \node[left] at (0,\y) {\name};
  }
  \draw[thick] (5.85,1.5)--(8,1.5);
  \draw[thick] (5.85,.5)--(8,.5);
  ...
  \QpuMeter{6.2}{-.5}
  \QpuMeter{6.2}{-1.5}
  \draw[thick] (6.55,-0.455)--(8,-0.455);
  \draw[thick] (6.55,-0.545)--(8,-0.545);
  \draw[thick] (6.55,-1.455)--(8,-1.455);
  \draw[thick] (6.55,-1.545)--(8,-1.545);
\end{tikzpicture}
\end{center}
