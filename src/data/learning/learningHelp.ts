...
export const gateHelp: Record<string, GateHelp> = {
  ...
  MEASURE: { name: 'Measure', summary: 'Reads the wire as a classical 0 or 1 and collapses any superposition. It cannot be undone.', rule: 'P(1) = |amplitude of |1⟩|²', reversible: false },
...
export const uiTips = {
  ...
  phaseAngle: 'θ for PHASE, in degrees.',
  ...
  measureTarget: 'Measure only the target wire now, without adding an M block to the circuit.',
