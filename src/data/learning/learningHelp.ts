...
export const uiTips = {
  ...
  increaseCycle: 'Insert an INCREASECYCLE boundary. This advances the logical stage but does not loop or repeat earlier gates. After compiling a REC/TREC child, cycle columns also show L# (LEVEL) and TCO/REC.',
  recursionDepth: 'Parent RUNCHILD of a recursive child must pass -DEPTH N. The compiler unrolls N frames (TCO when tail) into ordinary gates on the canvas.',
