 ...
 * timeline, and repository/build identity. GitHub Actions writes this JSON
 * into public/ so Vite copies it to dist for GitHub Pages.
 */
...
const githubHeaders = (token) => {
  const headers = {
    ...
    'User-Agent': 'BPForbes-QPU-project-metadata',
  };
